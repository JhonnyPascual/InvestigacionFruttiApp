...
public class Main2Activity_Nivel6 extends AppCompatActivity {
    ...
    int score, numAleatorio_uno, numAlestorio_dos, resultado, vidas=3;
    ...
    public void NumAleatorio(){
        if(score <= 1000000){
            ...
            numAlestorio_dos = (int)(Math.random() * 10);

            if(numAleatorio_uno >= 0 && numAleatorio_uno <= 3){
                resultado = numAleatorio_uno + numAlestorio_dos;
            ...
            Toast.makeText(this, "¡Sos un Genio!", Toast.LENGTH_SHORT).show();
